...
class KoreanToRoman(object):
    ...
    def phonetic_change(self) -> None:
        ...
        self.transcribed= re.sub('ㅄ', 'ㅂ', self.transcribed)
        self.transcribed= re.sub('ㅀ(!=/[ㅂㅈㄷㄱㄲㅅㅁㄴㅇㄹㅃㅎㅋㅌㅊㅍ]|$)', 'ㄹ', self.transcribed)
        self.transcribed= re.sub('ㄶ', 'ㄴ', self.transcribed)
        ...
        self.transcribed= re.sub('ㄿ', 'ㄹ', self.transcribed)
        ...
        self.transcribed= re.sub('ㄳ', 'ㄱ', self.transcribed)
